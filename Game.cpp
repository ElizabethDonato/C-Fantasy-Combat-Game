...
bool Game::play_game()
{
   ...
   if(playGame)
   {
	 ...
	 if(fighterAttack == -2)
	 {
	    ...
	    isStone = true;
	    std::cout <<"\nThe " << fighter1 ->get_type() << " Charm is effective!" << std::endl;
	 }
	 ...
	 if(fighterDefend == -1)
	 {
	    std::cout << "\n The " << fighter2 ->get_type() << " has charmed the " 
	    << fighter1 ->get_type() << "!  The " << fighter2 ->get_type() 
	    << " takes no damage this round!" << std::endl;
	    fighterAttack = 0;
	    fighterDefend = 0;
	 }
	    ...
	    if(fighterAttack == -2)
	    {
	       ...
	       isStone = true;
	       std::cout <<"\nThe " << fighter2 ->get_type() << " Charm is effective!" << std::endl;
	    }
	    ...
	    if(fighterDefend == -1)
	    {
	       std::cout << "\n The " << fighter1 ->get_type() << " has charmed the "
